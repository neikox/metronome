...
var realTempo = 60000 / bpm;
var screen = document.querySelector(".screen");
screen.textContent = bpm;

function start() {
  var dontStopMeNow = setInterval(beat.play(), realTempo);
}
...
var greenButton = document.querySelector(".start");
greenButton.addEventListener("click", start);
var redButton = document.querySelector(".end");
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "45299" + '/');
